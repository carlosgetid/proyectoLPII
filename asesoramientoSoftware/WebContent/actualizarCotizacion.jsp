...
<body>
	...
	<div class="container">
  		<form method="post" action="" method="post" id="id_registrar">
  		 <input type="hidden" id="idEstado" value="${cotizacion.nombreEstado}">
		  <div class="form-group">
			    <label for="exampleFormControlTextarea1">Codigo</label>
			    <input type="text" class="form-control" id="exampleFormControlTextarea1" name="codigo" value="${cotizacion.codigo}" placeholder="Ingresar codigo" rows="3" readonly>
			  </div>
			 <div class="form-group">
			    <label for="exampleFormControlTextarea1">Monto</label>
			    <input  class="form-control" id="exampleFormControlTextarea1" value="${cotizacion.monto}" name="origen" placeholder="Ingresar monto" rows="3" >
			  </div>
			  <div class="form-group">
...
<!-- 		  <button type="button" class="btn btn-success">Nuevo Informe</button> -->
	...
	$(".btn-primary").click(function(){
		$("#id_registrar").attr("action","ServletCotizacion?accion=ACTUALIZAR");
		id_registrar.submit();
	})
...
// 	})
	$(".btn-success").click(function(){
		window.location.href='listarCotizacion.jsp';
	})
