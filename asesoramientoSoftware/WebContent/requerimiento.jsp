...
<body>
	...
	<div class="container">
		<form method="post" action="ServletRequerimiento?accion=REGISTRAR"
			method="post" id="id_registrar">
			<div class="form-group">
				<label for="exampleFormControlTextarea1">Descripcion</label> <input
					...
					name="descripcion" placeholder="Ingresar descripcion" rows="3">
			</div>
			<div class="form-group">
				<label for="exampleFormControlTextarea1">Origen</label>
				<textarea class="form-control" id="exampleFormControlTextarea1"
					name="origen" placeholder="Ingresar origen" rows="3"></textarea>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="exampleFormControlSelect1">Criticidad</label> <select
					class="form-control" name="criticidad">
			...
			<div class="form-check form-check-inline">
				<input class="form-check-input" type="radio" name="estado"
					id="inlineRadio1" value="Terminado"> <label
					class="form-check-label" for="inlineRadio1">Terminado</label>
			</div>
			<div class="form-check form-check-inline">
				<input class="form-check-input" type="radio" name="estado"
					id="inlineRadio2" value="En proceso"> <label
					class="form-check-label" for="inlineRadio2">En proceso</label>
			</div>
			<div class="form-check form-check-inline">
				<input class="form-check-input" type="radio" name="estado"
					id="inlineRadio3" value="Pendiente"> <label
