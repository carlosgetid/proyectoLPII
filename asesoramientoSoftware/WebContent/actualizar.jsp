...
<body>
	...
	<div class="container">
		  ...
		  <div class="form-group">		
			    ...
			    <textarea  class="form-control" id="exampleFormControlTextarea1" name="descripcion"  placeholder="Ingresar descripcion" rows="3" >${requerimiento.descripcion}</textarea>
			  </div>
			 <div class="form-group">
			    <label for="exampleFormControlTextarea1">Origen</label>
			    <input  class="form-control" id="exampleFormControlTextarea1" value="${requerimiento.origen}" name="origen" placeholder="Ingresar origen" rows="3" >
			  </div>
			  <div class="form-group">
			    <label for="exampleFormControlTextarea1">Area</label>
			    <input  class="form-control" id="exampleFormControlTextarea1" name="area" value="${requerimiento.area}" placeholder="Ingresar area" rows="3" >
			  </div>
			  <div class="form-group">
...
<body>
	...
	<div class="container">
		<form method="post" action="" method="post" id="id_registrar">
			<input type="hidden" id="idCriticidad"
				value="${requerimiento.criticidad}">
			<div class="form-group">
				<label for="exampleFormControlTextarea1">Codigo</label> <input
					type="text" class="form-control" id="exampleFormControlTextarea1"
					name="codigo" value="${requerimiento.codigo}"
					placeholder="Ingresar descripcion" rows="3">
			</div>
			<div class="form-group">
				<label for="exampleFormControlTextarea1">Descripcion</label> <input
					type="text" class="form-control" id="exampleFormControlTextarea1"
					name="descripcion" value="${requerimiento.descripcion}"
					placeholder="Ingresar descripcion" rows="3">
			</div>
			<div class="form-group">
				<label for="exampleFormControlTextarea1">Origen</label>
				<textarea class="form-control" id="exampleFormControlTextarea1"
					name="origen" placeholder="Ingresar origen" rows="3">${requerimiento.origen}</textarea>
			</div>
			<div class="form-group">
				<label for="exampleFormControlTextarea1">Area</label> <input
					type="text" class="form-control" id="exampleFormControlTextarea1"
					name="area" placeholder="Ingresar area" rows="3"
					value="${requerimiento.area}">
			</div>
			<div class="form-group">
				<label for="exampleFormControlSelect1">Criticidad</label> <select
					class="form-control" name="criticidad" id="idcriticidad">
					<option>[Seleccione]</option>
					<option value="Necesario">Necesario</option>
					<option value="Importante">Importante</option>
					<option value="Deseado">Deseado</option>
			...
			<div class="form-check form-check-inline">
				<input class="form-check-input" type="radio" name="estado"
					id="inlineRadio1" value="${requerimiento.estado}"> <label
					class="form-check-label" for="inlineRadio1">Terminado</label>
			</div>
			<div class="form-check form-check-inline">
				<input class="form-check-input" type="radio" name="estado"
					id="inlineRadio2" value="${requerimiento.estado}"> <label
					class="form-check-label" for="inlineRadio2">En proceso</label>
			</div>
			<div class="form-check form-check-inline">
				<input class="form-check-input" type="radio" name="estado"
					id="inlineRadio3" value="${requerimiento.estado}"> <label
					class="form-check-label" for="inlineRadio3">Pendiente</label>
			</div>
	...
	<script>
		$(".btn-primary").click(
				function() {
					$("#id_registrar").attr("action",
							"ServletRequerimiento?accion=ACTUALIZAR");
					id_registrar.submit();
				})
		$(".btn-warning").click(
				function() {
					$("#id_registrar").attr("action",
							"ServletRequerimiento?accion=ELIMINAR");
					id_registrar.submit();
				})
		$(".btn-success").click(function() {
