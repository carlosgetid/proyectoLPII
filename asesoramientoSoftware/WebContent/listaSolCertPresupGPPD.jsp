...
function tabla(){
		$.getJSON("ServletSolicitud",{accion:"LISTAR"},function(response){
			...
			$.each(response,function(index,item){
				...
				var consultar= "<a href='ServletCertificado?accion=CONSULTAR&codigo="+item.codigo+"' target='_blank'>MostrarPDF</a>"
				var nuevo= "<a href='ServletCertificado?accion=NUEVO&codigo="+item.codigo+"'>Nuevo</a>"
